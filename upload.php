	                	...
	                	<div class="fxo-fileupload-container">
							<div class="fxo-fileupload-content" style="z-index: -1;">
								...
								<div ng-class="{'fxo-fileupload-methodbox-wide': back, 'fxo-fileupload-methodbox-narrow': !back}" class="hero-unit fxo-fileupload-methodbox-narrow">
								    ...
								    <div ng-class="{'fxo-fileupload-splitbox-33':back, 'fxo-fileupload-splitbox-50':!back}" ng-show="back" class="fxo-fileupload-splitbox fxo-fileupload-splitbox-50" style="display: none;">
							...
							<div class="fxo-fileupload-progressbar" style="display: none;">
